                ...
                <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-white/80 mt-1">Fill in the details to add a new product to your store</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                                ...
                                <div>
                                    ...
                                    <p class="mt-2 text-sm text-gray-400">Write a compelling description to attract customers</p>
                                </div>
                            </div>
                            ...
                            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                                <div class="flex items-center gap-3 mb-6">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">Add an image URL for your product</p>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="mt-2 text-sm text-gray-400">Enter a valid URL to your product image</p>
                                </div>
                            </div>
                        </div>
