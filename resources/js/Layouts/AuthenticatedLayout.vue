...
const navItems = computed(() => {
    ...
    return [
        ...
        { name: 'Admin', href: route('admin.orders.index'), active: route().current('admin.*'), icon: 'clipboard' },
    ];
});
                            ...
                            <div class="hidden lg:flex items-center">
                                <div class="relative">
                                    ...
                                    <input 
                                        type="text" 
                                        placeholder="Cari..." 
                                        class="w-48 pl-9 pr-4 py-2 text-sm bg-gray-100 border-0 rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-500 transition-all"
                                    />
                                </div>
                            </div>
